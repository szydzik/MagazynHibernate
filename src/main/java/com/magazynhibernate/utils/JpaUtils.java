...
import com.magazynhibernate.data.Slownik;
/**
 *
 * @author damian
 */
...
//		System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "error");
		...
		properties.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/magazynp");
...
//		properties.setProperty("hibernate.temp.use_jdbc_metadata_defaults", "false");
		...
		configuration.addAnnotatedClass(Magazynp.class);
                configuration.addAnnotatedClass(Slownik.class);
